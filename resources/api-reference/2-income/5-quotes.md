...
{
  "customer_id": 779, // The unique ID of the customer
  "valid_until": "2024-11-14", // The date until the invoice is valid
  "invoice_number": "", // The number assigned to the invoice (empty if not set)
  "gross_amount": 1, // The total amount before any discounts or taxes
  "discount_amount": 0.0, // The discount applied to the invoice
  "amount_due": 1.03, // The total amount due after discounts and taxes
  "items": [
    {
      "uid": "_8clixzycr", // The unique identifier for the item
      "id": 13387, // The ID of the item in the system
      "product_id": 13387, // The product ID related to the item
      "description": "", // The description of the item (empty if not set)
      "unit_price": 1, // The price per unit of the item
      "applied_taxes": [4], // The list of tax IDs applied to the item
      "invoice_quantity": 1, // The quantity of the item in the invoice
      "tax_amount": 0.03, // The tax amount applied to the item
      "invoice_amount": 1, // The total amount for the item in the invoice before taxes
      "quantity_error": false, // Boolean indicating if there was a quantity error
      "amount_due": 1.03, // The amount due for the item after taxes
  ...
  "note": "", // A note attached to the invoice (empty if not set)
  "tag": "", // A tag attached to the invoice (empty if not set)
  "logo_position": "left", // The position of the logo on the invoice
  "color": "#FFAD45", // The color theme used for the invoice
  "fx_amount": 1.03, // The foreign exchange amount in the invoice
  "fx_rate": 1, // The foreign exchange rate applied
  "base_currency": "GHS", // The currency used by the business
  "fx_currency": "GHS" // The foreign currency used (same as base in this case)
}
, {
  headers: {
...
{
  "quote_id": "QTE12345", // Represents the ID of the quote you wish to send
  "send_tome": 1, // Boolean value representing whether to send a copy to your business email (can be 1 for true or 0 for false)
  "other_emails": "client1@example.com, client2@example.com", // (optional) Represents other emails you wish to send the quote to
  "message": "Thank you for your interest. Please find the quote attached.", // The message body of the email
}, 
{
  headers: {
    accept: "application/json",
