...
{
  "business_name": "Acme Corp", // The customer's business name. You can use this to represent the customer's name
  "business_address": "123 Business St, Cityville", // The customer's business address. You can use this to represent the customer's address
  "business_phone": "+1234567890", // The customer's business phone number. You can use this to represent the customer's phone number
  "business_email": "contact@acmecorp.com", // The customer's business email. You can use this to represent the customer's email
  "category_id": "CAT001", // The category the customer belongs to
  "first_name": "John", // (optional) The first name of the contact person
  "last_name": "Doe", // (optional) The last name of the contact person
  "phone_number": "+0987654321" // (optional) The phone number of the contact person
}, 
{
  headers: {
...
{
  "name" : "invoices" //The name of the category
  "description" : "income from sale of prodcuts" //The description of the category
}, 
  headers: {
    accept: "application/json",
    authorization: "Bearer <API-KEY>",
