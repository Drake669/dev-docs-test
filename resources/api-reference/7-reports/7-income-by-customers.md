...
const response = await axios.post(
  ...
  {
  "id": "IC12345", // The ID of the income by customer
  "start_date": "2024-01-01T00:00:00Z", // Represents the start date of the income by customer
  "end_date": "2024-12-31T23:59:59Z" // Represents the end date of the income by customer
},
headers: {
...
const response = await axios.post(
  ...
  {
  "send_tome": "2024-11-06",  // The time when the income is sent
  "other_emails": ["example1@example.com", "example2@example.com"],  // Other email addresses to send the income details to
  "message": "This is the income details for the given period."  // The message content for the income to be sent to the email addresses
},
  headers: {
  accept: "application/json",
  authorization: "Bearer <API-KEY>",
