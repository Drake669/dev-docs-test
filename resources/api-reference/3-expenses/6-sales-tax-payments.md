...
const response = await axios.post(
  ...
  "date": "2024-11-14T12:00:00Z", // The date for adding the income tax
  "tax_accountID": "TAXACCOUNT123", // The tax account ID
  "payment_accountID": "PAYACCOUNT456" // The payment account ID
},
  headers: {
